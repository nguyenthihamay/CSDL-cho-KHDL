...
--Nếu có nhiều người cùng tên "Le Van C", câu lệnh sẽ cập nhật tất cả
--Để chính xác hơn, nên dùng MaNV thay vì HoTen
--Giải pháp:

--Xác định đúng MaNV trước khi cập nhật
SELECT MaNV FROM NhanVien WHERE HoTen = 'Le Van C';
UPDATE NhanVien 
SET PhongBan = 'Marketing' 
WHERE MaNV = 3;
